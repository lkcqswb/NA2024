...
int main() {
    ...
    ofstream outfile1("ppform_2_3.txt", ios::trunc);
    double t;
    if(!j["boundary condition"].is_null()){
        if(j["boundary condition"]=="complete"){
            ppform_2_3_complete pp(j);
    ...
    string command = "python plot.py ppform_2_3.txt";
